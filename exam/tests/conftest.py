...
def pytest_configure(config):
    ...
    # Question 5
    config.addinivalue_line("markers", "question_five_part_a: Question 5 Part (a)")
    config.addinivalue_line("markers", "question_five_part_b: Question 5 Part (b)")
    config.addinivalue_line("markers", "question_five_part_c: Question 5 Part (c)")
    # Question 6
    config.addinivalue_line("markers", "question_six_part_a: Question 6 Part (a)")
    config.addinivalue_line("markers", "question_six_part_b: Question 6 Part (b)")
    config.addinivalue_line("markers", "question_six_part_c: Question 6 Part (c)")
    # Question 7
    config.addinivalue_line("markers", "question_seven_part_a: Question 7 Part (a)")
    config.addinivalue_line("markers", "question_seven_part_b: Question 7 Part (b)")
    config.addinivalue_line("markers", "question_seven_part_c: Question 7 Part (c)")
    # Question 8
    config.addinivalue_line("markers", "question_eight_part_a: Question 8 Part (a)")
    config.addinivalue_line("markers", "question_eight_part_b: Question 8 Part (b)")
    config.addinivalue_line("markers", "question_eight_part_c: Question 8 Part (c)")
