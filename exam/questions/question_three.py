...
# - Return an integer that is the sum of all of the numbers up to and including
#   the stop value
# - If the stop value is less than 0, the function should return 0 to indicate
#   an invalid input
...
def sum_stop_int(stop: int) -> int:
    """Sum all of the numbers up to and including the provided stop value."""
    return stop
...
# - Return a float that is the sum of all of the numbers up to and including
#   the stop value
# - The step value should be used to determine the increment between each number
#   in the summation
# - If the stop value is less than 0, the function should return 0 to indicate
#   an invalid input
...
# - Return an integer that is the sum of all of the counts of function calls
#   in the provided dictionary
# - The dictionary will have string keys and integer values that represent
#   the count of function calls
